        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3 mb-4 sm:mb-0">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm sm:text-base mt-1 truncate" style={{ color: 'var(--muted-foreground)' }}>Gerencie seus treinos personalizados</p>
            </div>
          </div>
          
          {/* Linha inferior: botão novo treino */}
